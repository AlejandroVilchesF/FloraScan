      ...
      <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center">
          ...
          <div class="col-12 col-md-5 order-2 order-md-1 text-center leftCard">
            <img src="~@/assets/img/flora-logo.jpg" class="img-fluid rounded-end d-none d-md-block" style="width: 800px;"/>
          ...
          <div class="col-md-8 col-lg-7 col-xl d-flex justify-content-center align-items-center order-1 order-md-2">
            <div class="col-xl-8">
              ...
              <div :class="showForm ? 'd-block' : 'd-none'">
                ...
                <!-- Controles -->
                <div class="w-100 text-center my-2" v-if="showAuthForm">{{ '¿No tienes cuenta? ' }}<a href="#" style="text-decoration: none;" @click="loadAnimation('showRegisterForm')"><i class="fas fa-user-plus"></i>{{ ' Regístrate' }}</a></div>
                <div class="w-100 d-flex align-items-center" :class="(showRegisterForm) ? 'justify-content-between':'justify-content-end'">
                  <a href="#" style="text-decoration: none;" class="ms-4 ms-md-0"  @click="loadAnimation('showAuthForm')" v-if="showRegisterForm"><i class="fas fa-right-to-bracket"></i>{{ ' Inicia sesión' }}</a>
