      ...
      <div class="modal-content">
        <div class="modal-header" :style="styleHeader">
          <h5 class="modal-title" id="exampleModalLabel" v-if="title != null">
            {{ title }}
            <div v-if="subtitle1"><small>{{ subtitle1 }}</small><small class="text-danger">{{ subtitle1_2 }}</small></div>
            <div v-if="subtitle2"><small>{{ subtitle2 }}</small><small class="text-primary">{{ subtitle2_2 }}</small></div>
            <div v-if="subtitle3"><small>{{ subtitle3 }}</small><small class="text-success">{{ subtitle3_2 }}</small></div>
          </h5>
          <!-- SLOT -->
